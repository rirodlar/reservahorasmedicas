...
public class PersonaDAO {
	...
	public static boolean save(orm.Persona persona) throws PersistentException {
		try {
			orm.SintítuloPersistentManager.instance().saveObject(persona);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Persona persona) throws PersistentException {
		try {
			orm.SintítuloPersistentManager.instance().deleteObject(persona);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(orm.Persona persona)throws PersistentException {
		try {
			...
			for(int i = 0; i < lReservas.length; i++) {
				lReservas[i].setPersona_id_ingresa_reserva(null);
			}
	...
	public static boolean refresh(orm.Persona persona) throws PersistentException {
		try {
			orm.SintítuloPersistentManager.instance().getSession().refresh(persona);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Persona persona) throws PersistentException {
		try {
			orm.SintítuloPersistentManager.instance().getSession().evict(persona);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
